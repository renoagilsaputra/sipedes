	...
	<div class="container p-5">
		<div class="row ml-5">
			<div class="col-lg-6">
				...
				<p class="text-justify mt-2">Adalah salah seorang warga Kelurahan Desa Kedondong telah memohon surat keterangan cerai bahwa nama tersebut diatas pada saat dibuatnya surat keterangan ini sudah atau sedang melakukan proses perceraian.</p>
