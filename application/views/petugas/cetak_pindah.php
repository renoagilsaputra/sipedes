	...
	<div class="container p-5">
		<div class="row ml-5">
			<div class="col-lg-6">
				...
				<p class="text-justify mt-3">Yang bertandatangan dibawah ini, menerangkan pemohonan pindah penduduk dengan data sebagai berikut </p>
				<table class="ml-5">
					<tr>
						<td>NIK</td>
						<td width="50px"></td>
				...
				<table class="ml-5 dk" width="200px" border="1px">
					...
					<?php 
						$ci =& get_instance();
						$kgg = $ci->db->get_where('keluarga_pindah',['id_suket_pindah' => $ply['id_suket_pindah']])->result_array();
						foreach($kgg as $kg) :
					?>
					<tr>
						<td><?= $kg['nik']; ?></td>
				...
				<p class="text-justify mt-2">Demikian Surat Keterangan ini dibuat untuk digunakan seperlunya.</p>
			</div>
		</div>
	</div>
	<div class="container p-5">
