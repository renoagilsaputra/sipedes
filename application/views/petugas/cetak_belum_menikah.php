	...
	<div class="container p-5">
		<div class="row ml-5">
			<div class="col-lg-6">
				...
				<p class="text-justify mt-3">Yang bertandatangan di bawah ini Kepala Desa Kedondong, Kecamatan Sokaraja, Kabupaten Banyumas, menerangkan bahwa :</p>
				<table class="ml-5">
					<tr>
						<td>NIK</td>
						<td width="50px"></td>
				...
				<p class="text-justify mt-2">Adalah salah seorang warga Kelurahan Desa Kedondong telah memohon surat keterangan belum menikah menerangkan bahwa nama tersebut diatas pada saat dibuatnya surat keterangan ini belum pernah menikah dengan siapapun.</p>
	...
	<div class="container p-5">
		<div class="row">
			<div class="col-lg-8 ml-5">
				<p class="text-left">Kedondong,</p>
				<p class="text-left">Yang Menyatakan</p>
			</div>
			<div class="col-lg-4 mr-5">
				<p class="text-right">Mengetahui,</p>
				<p class="text-right">Kepala Desa Kedondong</p>
			</div>
		</div>
	</div>
</body>
