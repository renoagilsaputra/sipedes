	...
	<div class="container p-5">
		<div class="row ml-5">
			<div class="col-lg-6">
				...
				<p class="text-justify mt-3">Kelurahan Desa Kedondong, Kecamatan Sokaraja, Kabupaten Banyumas, dengan ini menerangkan bahwa :</p>
				<table class="ml-5">
				...
				<p class="text-justify mt-2">Benar yang namanya tersebut diatas adalah anak pasangan dari suami istri yang menikah dengan sah .</p>
				<table class="ml-5">
					<tr>
						<td>Nama Ayah</td>
						<td>:</td>
