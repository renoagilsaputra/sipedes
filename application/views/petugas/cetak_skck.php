	...
	<div class="container p-5">
		<div class="row ml-5">
			<div class="col-lg-6">
				...
				<p class="text-justify mt-2">Adalah salah seorang warga Kelurahan Desa Kedondong telah memohon surat keterangan SKCK menerangkan bahwa nama tersebut diatas benar-benar berkelakuan baik dan belum pernah terkena tindak pidana apapun.</p>
