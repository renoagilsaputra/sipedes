	...
	<div class="container p-5">
		<div class="row ml-5">
			<div class="col-lg-6">
				...
				<p class="text-justify mt-2">Mengajukan permohonan sehubung dengan akan mengadakan kegiatan keramaian sebagai berikut :</p>
