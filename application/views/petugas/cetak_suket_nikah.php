	...
	<div class="container p-5">
		<div class="row ml-5">
			<div class="col-lg-6">
				...
				<p class="text-justify mt-2">Benar yang tersebut namanya diatas akan mnyelenggarakan akad nikah yang bertempat di Desa Kedondong dengan saudara/i yang tersebut namanya dibawah ini : </p>
				<table class="ml-5">
					<?php 
						$ci =& get_instance();
						$pg = $ci->db->get_where('pasangan',['id_pasangan' => $ply['id_pasangan']])->row_array();
					?>
					<tr>
						<td>NIK</td>
						<td width="50px"></td>
					...
					<tr>
						...
						<td>:</td>
						<td><?php
								$tgll = date_create($pg['tgl_lahir']);
								echo date_format($tgll, 'd-m-Y')
