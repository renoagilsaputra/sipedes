<div class="container mt-2">
	<div class="row">
		<?php 
			$ci =& get_instance();
			$pd = $ci->db->get_where('penduduk', ['id_penduduk' => $ci->session->userdata('id_penduduk')])->row_array();
		?>
					...
					<div class="col-lg-12">
						...
						<div class="form-group">
							...
							<select name="jk" class="form-control">
								...
								<option value="<?= $jk; ?>" <?= ($jk == $pd['jk']) ? 'selected' : ''; ?>>
						...
						<div class="form-group">
							...
							<select name="status_perkawinan" class="form-control">
								...
								<option value="<?= $sp; ?>" <?= ($sp == $pd['status_perkawinan']) ? 'selected' : ''; ?>>
									<?= $sp; ?></option>
								<?php endforeach; ?>
							</select>
						...
						<div class="form-group">
							...
							<textarea name="alamat" class="form-control"
								placeholder="Alamat"><?= $pd['alamat']; ?></textarea>
						...
						<div class="form-group">
							...
							<div id="image-holder">
								<img src="<?= base_url('assets/img/penduduk/').$pd['foto']; ?>"
									class="img-fluid img-thumbnail" width="100%" alt="">
							</div>
